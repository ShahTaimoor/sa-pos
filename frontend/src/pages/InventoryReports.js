...
const InventoryReports = () => {
  ...
  const { data: reportsData, isLoading: reportsLoading, error: reportsError } = useQuery(
    ['inventoryReports', filters],
    () => inventoryReportsAPI.getReports(filters),
    {
  ...
  const { data: quickSummary, isLoading: summaryLoading, error: summaryError } = useQuery(
    'inventoryReportsQuickSummary',
    () => inventoryReportsAPI.getQuickSummary(),
    {
      onError: (error) => {
  ...
  const { data: quickStockLevels, isLoading: stockLevelsLoading } = useQuery(
    'inventoryReportsQuickStockLevels',
    () => inventoryReportsAPI.getQuickStockLevels({ limit: 5 }),
    {
      onError: (error) => {
  ...
  const { data: quickTurnoverRates, isLoading: turnoverRatesLoading } = useQuery(
    'inventoryReportsQuickTurnoverRates',
    () => inventoryReportsAPI.getQuickTurnoverRates({ limit: 5, period: '30d' }),
    {
      onError: (error) => {
  ...
  const { data: quickAgingAnalysis, isLoading: agingAnalysisLoading } = useQuery(
    'inventoryReportsQuickAgingAnalysis',
    () => inventoryReportsAPI.getQuickAgingAnalysis({ limit: 5, threshold: 90 }),
    {
      onError: (error) => {
  ...
  const deleteReportMutation = useMutation(inventoryReportsAPI.deleteReport, {
    onSuccess: () => {
  ...
  const toggleFavoriteMutation = useMutation(
    ({ reportId, isFavorite }) => inventoryReportsAPI.toggleFavorite(reportId, isFavorite),
    {
      onSuccess: () => {
        queryClient.invalidateQueries('inventoryReports');
  ...
  const handleRefresh = () => {
    queryClient.invalidateQueries('inventoryReports');
    queryClient.invalidateQueries('inventoryReportsQuickSummary');
    queryClient.invalidateQueries('inventoryReportsQuickStockLevels');
    queryClient.invalidateQueries('inventoryReportsQuickTurnoverRates');
    queryClient.invalidateQueries('inventoryReportsQuickAgingAnalysis');
