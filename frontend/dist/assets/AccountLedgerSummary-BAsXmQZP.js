import{r as l,d as Te,y as R,p as e,S as et,aI as Fe,Q as $,aA as Be,a2 as Oe,bT as Qe,O as _e}from"./index-DaTQeIrM.js";import{c as tt,d as st,e as rt}from"./accountLedgerApi-4EeWRvs_.js";import{u as at}from"./suppliersApi-DE3TTIcG.js";import{P as nt}from"./printer-sSBWtYCz.js";import{D as lt}from"./download-sNUxQ2Ce.js";import{C as Ge}from"./chevron-down-5FLXPK9w.js";const ut=()=>{var D,U,q,V,H,W,Y,J,K,X,Z,T,ee,te,se,re,ae,ne,le,ie,oe,ce,de,xe,me,he,pe,ge,ue,ye,fe,be,je,Ne,we,ve,Ce,Se,ke,Le,Ae;const b=(()=>{const t=new Date,s=new Date;return s.setMonth(t.getMonth()-1),{startDate:s.toISOString().split("T")[0],endDate:t.toISOString().split("T")[0]}})(),[i,z]=l.useState(""),[v,j]=l.useState(!1),[y,C]=l.useState(""),S=l.useRef(null),[m,F]=l.useState(""),[k,N]=l.useState(!1),[f,L]=l.useState(""),A=l.useRef(null),P=l.useRef(null),[n,B]=l.useState({startDate:b.startDate,endDate:b.endDate,search:""});l.useEffect(()=>{const t=s=>{S.current&&!S.current.contains(s.target)&&j(!1),A.current&&!A.current.contains(s.target)&&N(!1)};return(v||k)&&document.addEventListener("mousedown",t),()=>{document.removeEventListener("mousedown",t)}},[v,k]);const{data:p,isLoading:ot}=Te({search:y,limit:100},{refetchOnMountOrArgChange:!0}),I=l.useMemo(()=>{var t;return((t=p==null?void 0:p.data)==null?void 0:t.customers)||(p==null?void 0:p.customers)||(p==null?void 0:p.data)||p||[]},[p]),{data:g,isLoading:ct}=at({search:f,limit:100},{refetchOnMountOrArgChange:!0}),M=l.useMemo(()=>{var t;return((t=g==null?void 0:g.data)==null?void 0:t.suppliers)||(g==null?void 0:g.suppliers)||(g==null?void 0:g.data)||g||[]},[g]),De=l.useMemo(()=>{const t={...n};return i&&(t.customerId=i),m&&(t.supplierId=m),t},[n,i,m]),{data:o,isLoading:Ue,error:qe,refetch:Ve}=tt(De,{onError:t=>R(t,"Error fetching ledger summary")}),{data:r,isLoading:He}=st({customerId:i,startDate:n.startDate,endDate:n.endDate},{skip:!i,onError:t=>R(t,"Error fetching detailed transactions")}),{data:a,isLoading:We}=rt({supplierId:m,startDate:n.startDate,endDate:n.endDate},{skip:!m,onError:t=>R(t,"Error fetching detailed supplier transactions")}),O=((U=(D=o==null?void 0:o.data)==null?void 0:D.customers)==null?void 0:U.summary)||[],Q=((V=(q=o==null?void 0:o.data)==null?void 0:q.suppliers)==null?void 0:V.summary)||[];(W=(H=o==null?void 0:o.data)==null?void 0:H.customers)!=null&&W.totals,(J=(Y=o==null?void 0:o.data)==null?void 0:Y.suppliers)!=null&&J.totals;const w=((K=o==null?void 0:o.data)==null?void 0:K.period)||{};l.useMemo(()=>i?O.filter(t=>{var d,x;const s=((d=t.id)==null?void 0:d.toString())||((x=t._id)==null?void 0:x.toString()),h=i.toString();return s===h}):[],[O,i]);const _=l.useMemo(()=>{if(!y.trim())return I.slice(0,50);const t=y.toLowerCase();return I.filter(s=>{const h=(s.businessName||s.name||"").toLowerCase(),d=(s.email||"").toLowerCase(),x=(s.phone||"").toLowerCase();return h.includes(t)||d.includes(t)||x.includes(t)}).slice(0,50)},[I,y]);l.useMemo(()=>m?Q.filter(t=>{var d,x;const s=((d=t.id)==null?void 0:d.toString())||((x=t._id)==null?void 0:x.toString()),h=m.toString();return s===h}):[],[Q,m]);const G=l.useMemo(()=>{if(!f.trim())return M.slice(0,50);const t=f.toLowerCase();return M.filter(s=>{const h=(s.companyName||s.name||"").toLowerCase(),d=(s.email||"").toLowerCase(),x=(s.phone||"").toLowerCase();return h.includes(t)||d.includes(t)||x.includes(t)}).slice(0,50)},[M,f]),E=(t,s)=>{B({...n,[t]:s})},Ye=()=>{B({startDate:b.startDate,endDate:b.endDate,search:""}),z(""),C(""),F(""),L("")},Je=t=>{z(t._id),C(t.businessName||t.name||""),j(!1)},Ke=t=>{F(t._id),L(t.companyName||t.name||""),N(!1)},c=t=>new Intl.NumberFormat("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}).format(t||0),u=t=>{if(!t)return"";const s=new Date(t),h=s.getDate().toString().padStart(2,"0"),d=s.toLocaleDateString("en-US",{month:"short"}),x=s.getFullYear().toString().slice(-2);return`${h}-${d}-${x}`},Xe=()=>{_e.info("Export functionality coming soon")},Ze=()=>{var x,Pe,Ie,Me,Ee,Re,$e,ze;const t=P.current;if(!t){_e.error("No content to print. Please select a customer or supplier.");return}const s=window.open("","_blank"),h=i?((Pe=(x=r==null?void 0:r.data)==null?void 0:x.customer)==null?void 0:Pe.name)||"Customer Receivables":((Me=(Ie=a==null?void 0:a.data)==null?void 0:Ie.supplier)==null?void 0:Me.name)||"Supplier Payables",d=i?((Re=(Ee=r==null?void 0:r.data)==null?void 0:Ee.customer)==null?void 0:Re.accountCode)||"":((ze=($e=a==null?void 0:a.data)==null?void 0:$e.supplier)==null?void 0:ze.accountCode)||"";s.document.write(`
      <html>
        <head>
